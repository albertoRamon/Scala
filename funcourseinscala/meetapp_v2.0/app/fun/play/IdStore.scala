 ...
 */
 ...
 podemos def un wrapper generico:
 F[A]=A
 */
object IdStore extends Store[Id] {
  ...
  // Operadores de composición: esta parte es la que hay que particularizar de unaDB a otra  
  def returns[A](a: A): A = a  //implementar algo en un envoltorio que no existe
